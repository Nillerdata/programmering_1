...
public class Timetabel {
    ...
    private static void printDepartures(Departure[] departures) {
        ...
        for (Departure departure : departures) {
            if (departure != null) {//mere robust løsning er, hermed kan vi udvide arrayet, ved at lave if statement
    ...
    private static Departure[] getDepartures() {
        Departure[] departures = new Departure[8];/*fejlen lå her. der stod 10 i stedet for 8, hvilket
        gjorde at den ledte efter de sidste værdier i index */
