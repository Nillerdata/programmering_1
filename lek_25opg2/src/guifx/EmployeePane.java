...
public class EmployeePane extends GridPane {
	private TextField txfName, txfWage, txfCompany, txfSalary,txfEmployeeYear;
	...
	public EmployeePane() {
		...
		Label lblEmployeeYear = new Label("Employee Year : ");
		this.add(lblEmployeeYear,1,5);

		txfEmployeeYear = new TextField();
		this.add(txfEmployeeYear,2,5);
		txfEmployeeYear.setEditable(false);
	...
	public void updateControls() {
		...
		if (employee != null) {
			...
			if (employee.getCompany() != null) {
				...
				txfEmployeeYear.setText("år " + employee.getEmploymentYear());
			} else {
				txfCompany.clear();
				txfSalary.clear();
			}
